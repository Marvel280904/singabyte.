...
export default function InfiniteCarousel({ items, onSelect, selectedId }: CarouselProps) {
  ...
  return (
    ...
    <div ref={containerRef} className="relative w-full py-10 group">
      {/* Gradient Fade */}
...
function ProjectCard({ 
  ...
  return (
    <div 
        ...
        className={cn(
            "relative shrink-0 w-[300px] md:w-[550px] h-[450px] md:h-[400px] bg-black border transition-all duration-500 group/card cursor-pointer flex flex-col",
            isSelected 
