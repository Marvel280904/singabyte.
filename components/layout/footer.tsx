      ...
      <div className="px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-md text-white">
            ...
            <div className="flex gap-8">
                <Link href="/terms" className="hover:text-blue transition-colors cursor-default">
                    Terms & Conditions
                </Link>
                <Link href="/privacy-policy" className="hover:text-blue transition-colors cursor-default">
                    Privacy Policy
                </Link>
            </div>
        </div>
