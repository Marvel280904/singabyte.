    ...
    >
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        ...
        <div className="absolute inset-0 transition-all duration-500 opacity-50 group-hover:opacity-100 group-hover:shadow-[inset_0_0_20px_rgba(168,85,247,0.1)]">
            ...
            {/* Top Left Corner */}
            <div className="absolute top-0 left-0 h-6 w-6 border-l-2 border-t-2 border-blue" />
            
            {/* Top Right Corner */}
            <div className="absolute right-0 top-0 h-6 w-6 border-r-2 border-t-2 border-blue" />
            
            {/* Bottom Left Corner */}
            <div className="absolute bottom-0 left-0 h-6 w-6 border-b-2 border-l-2 border-blue" />
            
            {/* Bottom Right Corner */}
            <div className="absolute bottom-0 right-0 h-6 w-6 border-b-2 border-r-2 border-blue" />
      ...
      <div className="relative h-full p-8 flex flex-col justify-between z-10">
        ...
        <div className="absolute inset-0 pointer-events-none">
            {stars.map((star, i) => (
                <div
                    key={i}
                    className={`absolute rounded-full bg-blue transition-opacity duration-700 group-hover:animate-pulse ${star.size}`}
                    style={{
                        top: star.top,
                        left: star.left,
        ...
        {/* Top Content */}
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue/10 border border-blue/20 mb-6 backdrop-blur-md">
            ...
            <span className="text-xs font-bold text-blue uppercase tracking-widest">
              {badge}
            </span>
          </div>

          <h3 className="text-2xl font-bold text-white leading-snug mb-4 group-hover:text-blue-200 transition-colors">
            {title}
          </h3>
        ...
        {/* Bottom Content */}
        <div className="mt-4 md:mt-8 pt-6 border-t border-white/20 flex flex-row items-center justify-between gap-0">
            ...
            <div className="flex items-center gap-2 text-zinc-500 text-xs md:text-sm">
                ...
                <span>
                  Trusted <span className="hidden md:inline">by clients</span>
                </span>
            </div>
        </div>
      </div>
  ...
  return (
    <section className="relative w-full bg-black py-24 md:py-32 overflow-hidden" id="solution">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8"> 
        ...
        >
          {/* blue Overlay (Background Effect) */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] md:w-full h-[400px] md:h-[500px] bg-blue/15 md:bg-blue/10 blur-[100px] md:blur-[120px] rounded-full pointer-events-none" />
